...
mongodb://admin:admin@ds032340.mlab.com:32340/luizptm-cs-nodej
...
- Chamadas para este endpoint devem conter um header na requisição de Authentication com o valor "Bearer {token}" onde {token} é o valor do token passado 
  na criação ou sign in de um usuário.
